...
const IndexPart = props => {
  const query = useStaticQuery(graphql`
    ...
    query {
      image2: file(
        relativePath: { eq: "undraw_Mobile_application_mr4r (2).png" }
      ) {
        ...squareImage2
      }
      site {
    ...
    >
      ...
      <div className={styles.aboutContainer}>
        <Link style={{ boxShadow: `none` }} to="/about">
          <header className={styles.aboutTitle}>About me</header>
        </Link>
        <main className={styles.aboutContent}>
          <p>
            Hi, I am Jan (pronounced 'Yan' thanks to the strange German
            alphabet). I am a developer and consultant living in beautiful Tokyo
            &nbsp;
